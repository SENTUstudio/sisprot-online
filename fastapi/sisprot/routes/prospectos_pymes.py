...
from sisprot.schemas import ProspectosPymesInSchema
...
def edit(id: int, data: ProspectosPymesInSchema, session=Depends(get_db)):
...
def create(data: ProspectosPymesInSchema, session=Depends(get_db)):
    """
